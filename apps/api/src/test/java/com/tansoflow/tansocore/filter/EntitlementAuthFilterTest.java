...
class EntitlementAuthFilterTest {
    ...
    @Test
    void subscribeEndpoint_skipsFilter() throws ServletException, IOException {
        String accountId = UUID.randomUUID().toString();
        setAuthentication(accountId);

        MockHttpServletRequest request = clientRequest("/api/v1/account/subscribe");
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    @Test
    void subscriptionStatusEndpoint_skipsFilter() throws ServletException, IOException {
        String accountId = UUID.randomUUID().toString();
        setAuthentication(accountId);

        MockHttpServletRequest request = clientRequest("/api/v1/account/subscription-status");
        MockHttpServletResponse response = new MockHttpServletResponse();
